            ...
            <div class="navbar-inner">
                <div class="container">
                    <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                        <i class="icon-reorder shaded"></i></a><a class="brand" href="index.php">TAKE ME HOME</a>
                                    ...
                                    <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <select name = "Category" tabindex="1" value="SC" data-placeholder="Select Category" class="span6">
                                                    ...
                                                    <option value="eng">enginnering</option>
                                                    <option value="aigs">graduate studies</option>
                                                    <option value="apt">diploma</option>
...
<div class="footer">
            <div class="container">
                <b class="copyright">&copy; ACHARYA INSTITUTES OF THECHNOLOGY </b>All rights reserved.
            </div>
        </div>
